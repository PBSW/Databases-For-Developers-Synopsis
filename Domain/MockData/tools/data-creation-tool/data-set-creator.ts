import {GroceryList, GroceryListComplete, Product, ProductComplete, User} from "./models/models";
...
export class DataSetCreator {
    ...
    private _generateRandomLists(user: User): GroceryListComplete[] {
    ...
    private _getRandomProducts(): ProductComplete[] {
    ...
    private generateRandomDate(from: string, to: string): Date {
